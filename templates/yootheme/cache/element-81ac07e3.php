<?php // $file = C:/wamp64/www/rencontres/RencontresHexagram/templates/yootheme/vendor/yootheme/builder/elements/section/element.json
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          ...
          'title' => 'Settings', 
          'fields' => ['style', 'overlap', 'preserve_color', 'text_color', 'width', 'padding_remove_horizontal', 'width_expand', 'height', 'vertical_align', 'padding', 'padding_remove_top', 'padding_remove_bottom', 'header_transparent', 'header_transparent_noplaceholder', 'animation', 'animation_delay', [
              'label' => 'Title', 
              'type' => 'group', 
