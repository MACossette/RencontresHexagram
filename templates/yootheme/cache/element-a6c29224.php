<?php // $file = C:/wamp64/www/rencontres/RencontresHexagram/templates/yootheme/vendor/yootheme/builder/elements/popover_item/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['position_x', 'position_y', 'title', 'meta', 'content', 'image', 'image_alt', 'link', 'drop_position']
        ], [
          'title' => 'Advanced', 
          'fields' => ['source']
        ]]
