<?php // $file = C:/wamp64/www/rencontres/RencontresHexagram/templates/yootheme/vendor/yootheme/theme-joomla-modules/config/modules.json

return [
  'base' => $config->get('theme.url'), 
  'locale' => $config->get('locale.code'), 
  'fields' => [
    'visibility' => [
      'label' => 'Visibility', 
    ...
    'menu_style' => [
      ...
      'show' => '$match(this.type, "menu") && !$match(this.position, "toolbar-left|toolbar-right|navbar|mobile|header")'
    ]
  ]
];
